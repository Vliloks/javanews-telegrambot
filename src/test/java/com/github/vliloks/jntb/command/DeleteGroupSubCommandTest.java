...
import static com.github.vliloks.jntb.command.AbstractCommandTest.prepareUpdate;
...
class DeleteGroupSubCommandTest {
    ...
    public void shouldProperlyDeleteByGroupId() {
        ...
        Update update = prepareUpdate(chatId, String.format("%s %s", DELETE_GROUP_SUB.getCommandName(), groupId.toString()));
